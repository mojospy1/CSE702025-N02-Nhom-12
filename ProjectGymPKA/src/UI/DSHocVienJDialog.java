...
//    }
    ...
    public void soLuongHD() {
        try {
            ...
            slHD = listHD.size() + 1;
            System.out.println("So Luong Hoa Don Hien Co " + slHD);
        } catch (Exception e) {
        }
    }
    ...
    public void insert() {
        ...
        try {
            ...
            hdDAO.insert(mod);
            MsgBox.alert(this, "Thêm mới thành công ở bản Hóa Đơn!");
            fillTable();
        } catch (Exception e) {
            System.out.println(e);
    ...
    public void CapNhat() {
        ...
        try {
            ...
            MsgBox.alert(this, "Cập nhật thành công ở têm bản học viên!");
            this.fillTable();
        } catch (Exception e) {
            System.out.println(e);
        }
    ...
    public void delete() {
        ...
        if (MsgBox.confirm(this, "Bạn thực sự muốn xóa người học này")) {
            try {
                ...
                hdDAO.delete(maHV);
                MsgBox.alert(this, "Xóa thành công ở bản hóa đơn!");
