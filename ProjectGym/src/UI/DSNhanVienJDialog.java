...
//    }
    ...
    private void initComponents() {
        ...
        if (tblNhanVien.getColumnModel().getColumnCount() > 0) {
            tblNhanVien.getColumnModel().getColumn(0).setHeaderValue("Nhân Viên ID");
            tblNhanVien.getColumnModel().getColumn(1).setHeaderValue("Họ tên");
            tblNhanVien.getColumnModel().getColumn(2).setHeaderValue("Ngày Sinh");
            tblNhanVien.getColumnModel().getColumn(3).setHeaderValue("Email");
            tblNhanVien.getColumnModel().getColumn(4).setHeaderValue("SĐT");
            tblNhanVien.getColumnModel().getColumn(5).setHeaderValue("UserID");
            tblNhanVien.getColumnModel().getColumn(6).setHeaderValue("Vai trò");
        }
